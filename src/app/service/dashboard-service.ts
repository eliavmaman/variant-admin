...
export class DashboardService {
  ...
  getFramesByDate(from: any, to: any, monitorId) {
    ...
    if (localStorage.getItem('shinobi') != null) {
      ...
      return this.http.get('//51.15.77.204/' + shinobiData.auth_token + '/videos/' + shinobiData.ke +
        '/' + monitorId + '?start=' + fIso + '&endIsStartTo&end=' + eIso);
    }
  ...
  createMonitor(monitor: any) {
    ...
    return this.createMJPEGMonitor();
  }
  ...
  createMJPEGMonitor() {
    let defaultValues =
      {
        ...
        "details": {
          ...
          "dir": "",
          "auto_host_enable": "1",
          "auto_host": "http://157.242.44.67:80/mjpg/video.mjpg",
          "rtsp_transport": "tcp",
          "muser": "",
          "mpass": "",
          "port_force": "0",
    ...
    const shinobiData: any = JSON.parse(localStorage.getItem('shinobi'));
    var url = '//51.15.77.204/' + shinobiData.auth_token + '/configureMonitor/' + shinobiData.ke + '/' + defaultValues.mid;
    defaultValues.details = JSON.stringify(defaultValues.details);
    //var newMonitor = Object.assign(defaultValues, monitor)
    return this.http.post(url, {data: JSON.stringify(defaultValues)});
  }
